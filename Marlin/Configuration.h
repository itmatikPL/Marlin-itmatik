...
#define STRING_CONFIG_H_AUTHOR "(itmatik, Sapphire Pro)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 9.37,  9.37 }
    #define DEFAULT_Ki_LIST {   0.45,   0.45 }
    #define DEFAULT_Kd_LIST { 48.56, 48.56 }
  #else
     // Sapphire Pro itmatik
    #define DEFAULT_Kp 9.16
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.4, 1600, 416.33 }
 ...
 *   the Nozzle to the center-point of the Probe in the X and Y axes. M851 X0 Y-41 Z0
 *
 * Z offset
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -41, -1.62}
