...
#define NO_MOTION_BEFORE_HOMING // Inhibit movement until all axes have been homed [zmian 17092020]
...
#define Z_AFTER_HOMING  50      // (mm) Height to move to after homing Z [zmian 17092020]
