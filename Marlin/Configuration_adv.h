 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 60               // Seconds - zmiana na 60
...
#define HOMING_BACKOFF_POST_MM { 2, 25, 50 }  // (mm) Backoff from endstops after homing
...
//
  ...
  #define TFT_DISABLED_COLOR 0x0000
